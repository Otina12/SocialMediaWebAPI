        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Communities_Members_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Followings", x => new { x.FollowerId, x.CommunityId });
                    table.ForeignKey(
                        name: "FK_Followings_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Followings_Members_FollowerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Posts", x => new { x.Id, x.CommunityId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => new { x.Id, x.PostId, x.CommunityId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.PostId, x.CommunityId, x.MemberId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaObjects_Posts_PostId_CommunityId",
                        columns: x => new { x.PostId, x.CommunityId },
                        principalTable: "Posts",
                        principalColumns: new[] { "Id", "CommunityId" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikeComments", x => new { x.CommentId, x.PostId, x.CommunityId, x.MemberId });
                    table.ForeignKey(
                        name: "FK_LikeComments_Comments_CommentId_PostId_CommunityId",
                        columns: x => new { x.CommentId, x.PostId, x.CommunityId },
                        principalTable: "Comments",
                        principalColumns: new[] { "Id", "PostId", "CommunityId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LikeComments_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PostId_CommunityId",
                table: "Comments",
                columns: new[] { "PostId", "CommunityId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Followings_CommunityId",
                table: "Followings",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_LikeComments_MemberId",
                table: "LikeComments",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaObjects_PostId_CommunityId",
                table: "MediaObjects",
                columns: new[] { "PostId", "CommunityId" });
